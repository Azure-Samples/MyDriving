...
namespace Microsoft.Azure.Devices.Client
{
    ...
    public sealed class DeviceClient
    {
        ...
        static readonly Regex DeviceIdParameterRegex = new Regex(DeviceIdParameterPattern);
        ...
        //public AsyncTask OpenAsync() TODO: BrokenInPCL
        {
#if WINDOWS_UWP
            //return impl.OpenAsync().AsTaskOrAsyncOp(); TODO: BrokenInPCL
            return null;
#else
        ...
        public object ReceiveAsync(TimeSpan timeout)
        {
#if !WINDOWS_UWP
            if (this.impl == null)
            {
        ...
        public object CompleteAsync(string lockToken)
        {
#if !WINDOWS_UWP
            if (this.impl == null)
            {
        ...
        public object CompleteAsync(Message message)
        {
#if !WINDOWS_UWP
            if (this.impl == null)
            {
        ...
        public object AbandonAsync(string lockToken)
        {
#if !WINDOWS_UWP
            if (this.impl == null)
            {
        ...
        public object AbandonAsync(Message message)
        {
#if !WINDOWS_UWP
            if (this.impl == null)
            {
       ...
       // [Windows.Foundation.Metadata.DefaultOverloadAttribute()]
        ...
        /// </summary>
        /// <returns>The previously received message</returns>
        public object RejectAsync(string lockToken)
        //TODO: BrokenInPCL
        ...
        //TODO: BrokenInPCL
        public object RejectAsync(Message message)
        {
#if !WINDOWS_UWP
            if (this.impl == null)
            {
        ...
        public object SendEventAsync(Message message)
        //TODO: BrokenInPCL
        ...
        public object SendEventBatchAsync(IEnumerable<Message> messages)
        {
#if !WINDOWS_UWP
            if (this.impl == null)
            {
