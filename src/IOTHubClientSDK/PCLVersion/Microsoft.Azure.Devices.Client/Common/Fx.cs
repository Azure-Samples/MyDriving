...
namespace Microsoft.Azure.Devices.Client
{
    ...
    static class Fx
    {
        ...
        public static object ThunkCallback(object callback)
        {
        ...
        internal static bool FastDebug
        {
            get
            {
                if (!Fx.fastDebugRetrieved)
                {
                    ...
                    {
                        Fx.fastDebugCache = ((int)value) != 0; //&& typeof(int).IsAssignableFrom(value.GetType())  TODO: BrokenInPCL
                    }
        ...
        unsafe sealed class IOCompletionThunk
        {
            ...
            public IOCompletionThunk(object callback)
            {
                this.callback = callback;
            }
            ...
            void UnhandledExceptionFrame(uint error, uint bytesRead, object nativeOverlapped)
            //TODO: BrokenInPCL
