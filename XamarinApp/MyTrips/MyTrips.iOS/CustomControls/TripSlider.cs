...
namespace MyTrip.iOS
{
	...
	public class TripSlider : UIView
	{
		...
		public override void Draw(CGRect frame)
		{
			...
			var maximumTrackPath = UIBezierPath.FromRoundedRect(new CGRect(0.0f, 0.0f, expression3, 6.0f), UIRectCorner.TopLeft | UIRectCorner.BottomLeft, new CGSize(2.0f, 2.0f));
			...
			bezierPath.AddCurveToPoint(new CGPoint(11.29f, 16.56f), new CGPoint(13.0f, 14.15f), new CGPoint(12.23f, 15.73f));
