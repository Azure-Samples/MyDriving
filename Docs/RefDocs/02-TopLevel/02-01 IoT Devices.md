...
> Note: You can use the myDriving app on the phone without an OBD device. If you don't have an OBD device, the app collects GPS data and sends it to IoT Hub along with simulated OBD data.
