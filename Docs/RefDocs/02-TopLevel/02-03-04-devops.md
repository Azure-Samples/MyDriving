...
# Coding with Visual Studio and Git

We use [GitHub for our repository](https://github.com/Azure-Samples/Build2016ScottGuDemo), 
and Visual Studio for our coding.
Visual Studio is well integrated with GitHub - a lot of the usual tasks are made  from the Team Explorer window. 

![](./media/devops-git-110.png)

(Visual Studio also works with the more centralized repository service, 
Team Foundation Server, which is available both on-premises and in the cloud as part of 
